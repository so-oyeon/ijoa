...
GRAD_ACUMM_STEPS =  42 # 84  # set here the grad accumulation steps
...
config_dataset = BaseDatasetConfig(
    ...
    path="/home/j-k11d105/ijoa/app/dataset",
    meta_file_train="/home/j-k11d105/ijoa/app/dataset/metadata.txt",
    language="ko",
)
...
SPEAKER_REFERENCE = [
    "/home/j-k11d105/ijoa/app/dataset/wavs/audio2.wav" # speaker reference to be used in training test sentences
]
...
def main():
    ...
    train_samples, eval_samples = load_tts_samples(
        ...
        eval_split_size=0.01, ###########0.02, # config.eval_split_size,
    )
