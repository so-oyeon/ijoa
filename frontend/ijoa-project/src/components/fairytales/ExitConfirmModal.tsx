        ...
        <div className="px-4 py-8">
          ...
          <div className="flex gap-4 justify-center items-center">
            <button
              ...
              className="mt-6 w-28 py-2 text-white text-lg font-bold bg-[#FF8067] rounded-3xl border-2 border-[#FF8067]"
            >
              취소
            </button>
            <button
              onClick={handleExitClick}
              className="mt-6 w-28 py-2 text-white text-lg font-bold bg-[#67CCFF] rounded-3xl border-2 border-[#67CCFF]"
            >
              나가기
            </button>
          </div>
