  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="relative w-1/3 py-16 bg-white rounded-lg p-6">
        ...
        <p className="text-center text-gray-600 font-semibold mb-4">회원 정보 접근 시, 개인정보보호를 위해</p>
        <p className="text-center text-gray-600 font-semibold mb-4">본인확인을 진행합니다.</p>
        <input
          type="password"
          placeholder="비밀번호를 입력해 주세요."
          className="w-3/4 mb-4 p-2 border rounded-3xl focus:outline-none focus:border-blue-300"
        />
        <button className="w-1/3 py-2 bg-[#67CCFF] text-white rounded-3xl font-bold hover:bg-blue-500" onClick={onNext}>
          다음
        </button>
      </div>
    </div>
