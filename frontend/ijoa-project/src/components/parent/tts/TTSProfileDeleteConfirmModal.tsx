...
interface TTSProfileDeleteConfirmModalProps {
  isOpen: boolean;
  onClose: () => void;
  onDeleteConfirm: () => void;
}

const TTSProfileDeleteConfirmModal: React.FC<TTSProfileDeleteConfirmModalProps> = ({
  isOpen,
  onClose,
  onDeleteConfirm,
}) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 font-['MapleLight']">
      <div className="w-full max-w-xs md:max-w-md lg:max-w-lg text-center bg-white rounded-2xl shadow-lg mx-4">
        <div className="px-4 py-8">
          <div className="text-xl md:text-2xl font-bold">정말 더빙 보이스 프로필을 삭제하시겠습니까?</div>
...
export default TTSProfileDeleteConfirmModal;
